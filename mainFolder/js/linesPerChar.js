class CharLines {
    ...
    updateVis() {
        ...
        const aggregatedDataMap = d3.rollups(vis.data, v => v.length, d => d.character);
        ...
        for (let i = 0; vis.newData.length < 10; i++) {
          if (vis.aggregatedData[i].key == 'Michael' || vis.aggregatedData[i].key == 'Narrator' || vis.aggregatedData[i].key == 'G.O.B.' || vis.aggregatedData[i].key == 'Tobias' || vis.aggregatedData[i].key == 'Lindsay' || vis.aggregatedData[i].key == 'Buster' || vis.aggregatedData[i].key == 'Lucille' || vis.aggregatedData[i].key == 'Maeby' || vis.aggregatedData[i].key == 'George Michael' || vis.aggregatedData[i].key == 'George') {
